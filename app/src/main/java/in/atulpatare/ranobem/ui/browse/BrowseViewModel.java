...
public class BrowseViewModel extends ViewModel {
    ...
    private MutableLiveData<List<Manga>> searchItems;
    ...
    public MutableLiveData<HashMap<String, String>> getSortOptions(int sourceId) {
        MutableLiveData<HashMap<String, String>> options = new MutableLiveData<>();
        new Repository(sourceId).getSortOptions(new Repository.Callback<>() {
            @Override
            public void onComplete(HashMap<String, String> result) {
                options.postValue(result);
            }
